...
public class BaseTools {
    ...
    public static void copy(String content) {
        if (!TextUtils.isEmpty(content)) {
            try {
                // 得到剪贴板管理器
                ClipboardManager cmb = (ClipboardManager) BaseApplication.Companion.getContext().getSystemService(Context.CLIPBOARD_SERVICE);
    ...
    public static String getClipContent() {
        ClipboardManager manager = (ClipboardManager) BaseApplication.Companion.getContext().getSystemService(Context.CLIPBOARD_SERVICE);
